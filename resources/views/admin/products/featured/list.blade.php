...
@section('content')
    <div class="w-full mt-12">
        <p class="text-xl pb-3 flex items-center">
            <i class="fas fa-list mr-3"></i> Danh sách đặc sắc
        </p>
        ...
        <div class="bg-white overflow-auto">
            <table id="product-table" class="min-w-full bg-white border-collapse rounded-md">
                ...
                @include('admin.products.featured.partials.list')
            </table>
            <div class="flex justify-start mt-4">
                {{ $proFeatured->appends(['search' => request('search')])->links('pagination::tailwind') }}
            </div>
        </div>
    </div>
