            ...
            <div class="container mx-auto max-w-3xl p-6">
                <form action="{{ route('discounts.store') }}" method="POST" class="space-y-4">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="code" id="code" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" value="{{$code}}" placeholder="Nhập mã giảm giá">
                        @error('code')
