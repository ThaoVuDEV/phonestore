...
<html lang="en">
	...
	<body>
									...
									<div id="use_deropdown" class="collapse_dropdown collapse">
										<div class="dropdown_content">
											...
											<ul class="settings_options ul_li_block clearfix">
												<li><a href="{{route('ProfileUser')}}"><i class="fal fa-user-circle"></i> Profile</a></li>
												
												<li><a href="{{route('Userlogout')}}"><i class="fal fa-sign-out-alt"></i> Logout</a></li>
											</ul>
										</div>
									</div>
								</li>
		...
		<main>
			...
			================================================== -->
			<section class="breadcrumb_section text-white text-center text-uppercase d-flex align-items-end clearfix" data-background="{{asset('assets/images/breadcrumb/bg_16.jpg')}}">
