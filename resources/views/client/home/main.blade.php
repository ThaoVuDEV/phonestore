...
@section('content')
					...
					<div class="row justify-content-lg-between">
						<div class="col-lg-9 col-md-8">
							<div class="advertisement_image">
								<a href="#!">
									<img src="{{asset('assets/images/offer/electronic/img_04.jpg')}}" alt="image_not_found">
								</a>
							</div>
						</div>
						...
						<div class="col-lg-3 col-md-4">
							<div class="advertisement_image">
								<a href="#!">
									<img src="{{asset('assets/images/offer/electronic/img_05.jpg')}}" alt="image_not_found">
								</a>
							</div>
						</div>
					</div>
    ...
    <section class="feature_section electronic_feature_carousel mb_50 clearfix">
        <div class="slideshow1_slider clearfix" data-slick='{"arrows": false}'>
            <div class="item" data-background="{{asset('assets/images/banner2.png')}}">
                <div class="container maxw_1600">
                    <div class="row align-items-center justify-content-lg-between">
                        <div class="col-lg-7">
                            <div class="item_image">
                                <img src="{{asset('assets/images/banner6.png')}}" alt="image_not_found">
                            </div>
                        </div>
            ...
            <div class="item" data-background="{{asset('assets/images/banner3.png')}}">
                <div class="container maxw_1600">
                    <div class="row align-items-center justify-content-lg-between">
                        <div class="col-lg-7">
                            <div class="item_image">
                                <img src="{{asset('assets/images/banner5.png')}}" alt="image_not_found">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="item" data-background="{{asset('assets/images/banner4.png')}}">
                <div class="container maxw_1600">
                    <div class="row align-items-center justify-content-lg-between">
                        <div class="col-lg-7">
                            <div class="item_image">
                                <img src="{{asset('assets/images/banner1.png')}}" alt="image_not_found">
                            </div>
                        </div>
                    </div>
                </div>
